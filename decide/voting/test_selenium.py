...
class QuestionsTests(StaticLiveServerTestCase):
    ...
    def test_createWrongQuestionOptionRankedQuestion(self):
        ...
        self.driver.find_element(By.NAME, "_save").click()
        self.assertTrue(self.driver.current_url == self.live_server_url+"/admin/voting/questionoption/")
        self.assertTrue(self.driver.find_element(By.CLASS_NAME, "success").find_element(By.TAG_NAME, "a").text == "You cannot create a classic option for a non-classical question")
    ...
    def test_createWrongQuestionOptionClassicQuestion(self):
        ...
        self.driver.find_element(By.NAME, "_save").click()
        self.assertTrue(self.driver.current_url == self.live_server_url+"/admin/voting/questionoptionranked/")
        self.assertTrue(self.driver.find_element(By.CLASS_NAME, "success").find_element(By.TAG_NAME, "a").text == "You cannot create a ranked option for a non-ranked question")
...
class VotingTests(StaticLiveServerTestCase):
    ...
    def test_createClassicVoting(self):
        ...
        self.driver.find_element(By.ID, "id_desc").click()
        self.driver.find_element(By.ID, "id_desc").send_keys('Description Test')
        self.driver.find_element(By.ID, "id_question").click()
        self.driver.find_element(By.ID, "id_question").send_keys('Classic Question')
        self.driver.find_element(By.ID, "id_auths").click()
        self.driver.find_element(By.ID, "id_auths").send_keys(self.live_server_url)
        self.driver.find_element(By.NAME, "_save").click()
